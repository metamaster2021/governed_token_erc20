    ...
    contract TokenVesting is Ownable {
         ...
         */
        function release(HiToken token) public onlyOwner {
         ...
         * @param token ERC20 token which is being vested
         */
        function revoke(HiToken token) public onlyOwner {
         ...
         */
        function vested(HiToken token) public view returns (uint256) {
         ...
         * @param token ERC20 token which is being vested
         */
        function _releasableAmount(HiToken token) private view returns (uint256) {
         ...
         * @param token ERC20 token which is being vested
         */
        function _vestedAmount(HiToken token) private view returns (uint256) {
